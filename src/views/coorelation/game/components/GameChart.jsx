...
const GameChart = () => {
  ...
  const resetGame = () => {
    ...
    const colIndex = isTwoTailed
      ? 4 + alphaChoice.index   // two‐tail lives in columns 4–7
...
<div className="mt-10 max-h-96 overflow-auto border rounded-lg p-4">
  ...
  <table className="w-full table-auto border-collapse text-sm text-left">
    <thead className="bg-gray-100 sticky top-0 z-10">
      <tr>
        <th className="border px-2 py-1 align-bottom" rowSpan={2}>n</th>
        <th className="border px-2 py-1 text-center" colSpan={4}>1-tail test</th>
        <th className="border px-2 py-1 text-center" colSpan={4}>2-tail test</th>
      </tr>
      <tr>
