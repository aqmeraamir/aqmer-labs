import nft1 from "assets/img/cards/Banner1.png";
    ...
    >
      <div className="w-full">
        <h4 className="mb-[14px] max-w-full text-xl font-bold text-white md:w-[64%] md:text-3xl md:leading-[42px] lg:w-[46%] xl:w-[85%] 2xl:w-[75%] 3xl:w-[52%]">
          Discover, Simulate and Experiment!
        </h4>
        <p className="mb-[20px] max-w-full text-base font-medium text-[#E3DAFF] md:w-[64%] lg:w-[40%] xl:w-[72%] 2xl:w-[60%] 3xl:w-[45%]">
          Explore interactive mathematical models— simulate statisitcs, probabilities, physics and more to build an intuition with these tools.
        </p>
