import banner from "assets/img/cards/image.png";
    ...
    >
      <div className="w-full">
        ...
        <p className="mb-[20px] max-w-full text-base font-medium text-[#E3DAFF] md:w-[64%] lg:w-[40%] xl:w-[72%] 2xl:w-[60%] 3xl:w-[45%]">
          Explore interactive mathematical models- simulate statisitcs, probabilities, physics and more to build an intuition.
        </p>
